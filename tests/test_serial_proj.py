...
class TestSerialProj:
    ...
    def test_init(self):
        ...
        proj.run_exp(param, materializers, test_serial_proj)
        yield proj
    ...
    #     proj.run_exp(params, resume_config={
    #         'path': proj.query_experiments(lambda exp: exp.name == "test_exp1").run_data["run_dir"]
    #     })
